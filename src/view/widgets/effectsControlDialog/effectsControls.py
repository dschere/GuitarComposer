...
from models.effect import Effects, EffectModule
from models.note import Note
from view.widgets.effectsControlDialog.effectParameterRenderer import EffectParameterRenderer
from models.param import EffectParameter


EffectChanges = Dict[EffectModule, List[Tuple[str, EffectParameter]]]
...
class EffectsTabContent(QWidget):
    ...
    def __init__(self, effect: EffectModule):
        super().__init__()
...
class EffectsDialog(QDialog):
    ...
    def delta(self) -> EffectChanges:
        ...
        def pair(n) -> Tuple[EffectModule, EffectModule]:
            a1 = getattr(self.effects,n)
            a2 = getattr(self.original_effects,n)
            return (a1,a2)
