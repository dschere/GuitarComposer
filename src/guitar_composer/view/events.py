...
from guitar_composer.models.measure import Measure, TabEvent # type: ignore
...
from guitar_composer.models.filterGraph import GraphNode
 

#from guitar_composer.view.dialogs.effectsControlDialog.dialog import EffectChanges, EffectPreview
