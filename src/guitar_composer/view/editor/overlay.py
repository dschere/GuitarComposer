...
from guitar_composer.view.editor.measurePresenter import MeasurePresenter
from guitar_composer.view.editor.tabEventPresenter import TabEventPresenter


from guitar_composer.models.measure import Measure, TabEvent, TUPLET_DISABLED
from guitar_composer.models.track import Track
from guitar_composer.view.config import GuitarFretboardStyle

from guitar_composer.view.editor.glyphs.common import STAFF_SYM_WIDTH
