...
from guitar_composer.view.dialogs.stringBendDialog import StringBendDialog
from guitar_composer.view.editor.glyphs.canvas import Canvas
from guitar_composer.view.editor.glyphs.common import (BEND_SYMBOL, NO_ARTICULATION, ORNAMENT_ARTICULATION_Y, ORNAMENT_BEND_Y, ORNAMENT_DYNAMIC_Y, ORNAMENT_FONT_SIZE, ORNAMENT_STROKE_Y, ORNAMENT_Y, 
                                       STAFF_SYM_WIDTH, 
...
import math
from guitar_composer.view.config import GuitarFretboardStyle

from guitar_composer.view.events import StringBendEvent
