...
from guitar_composer.models.measure import Measure, TabEvent

from guitar_composer.view.editor import glyphs
from guitar_composer.view.editor.glyphs.common import DRUM_CLEFF, ORNAMENT_MARKING_HEIGHT, STAFF_ABOVE_LINES, STAFF_HEIGHT, STAFF_LINE_SPACING, STAFF_NUMBER_OF_LINES, STAFF_SYM_WIDTH
from guitar_composer.view.editor.tabEventPresenter import TabEventPresenter 
from guitar_composer.models.track import Track
from typing import Dict, List

from guitar_composer.view.events import Signals, EditorEvent

from guitar_composer.util.layoutGapWorkaround import adjust_size_to_fit
