...
from guitar_composer.models.measure import DynamicVariance, TabEvent
from guitar_composer.music.durationtypes import HALF, QUARTER, EIGHTH, SIXTEENTH
from guitar_composer.music.dynamic import *
