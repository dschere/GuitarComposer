...
from guitar_composer.models.measure import Measure, TabEvent, TimeSig, TUPLET_DISABLED
from guitar_composer.models.song import Song
from guitar_composer.models.track import Track
from guitar_composer.models.note import Note as GC_Note 


from guitar_composer.services.synth.synthservice import synthservice
from guitar_composer.music import durationtypes as dt
from guitar_composer.util.midi import midi_codes

from guitar_composer.view.events import Signals, ProgressEvent
import logging
